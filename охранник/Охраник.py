...
with sq.connect("base.db") as base: #создает таблицу
    cur = base.cursor()
    ...
    base.commit()
with sq.connect("gosti.db") as base2: #создает таблицу
    cur2 = base2.cursor()
...
class PassControlApp(QWidget):#основное окно
    def __init__(self):
        super().__init__()
        global cur
        global base
        ...
        self.issue_pass_button2 = QPushButton('Создать временный пропуск')
        self.issue_pass_button = QPushButton('Сотрудник вошёл')
        self.issue_pass_button3 = QPushButton('Сотрудник вышел')
        ...
        self.passv = QLineEdit(self, placeholderText="Имя сотрудника")
...
class App(QWidget):
    def __init__(self):
        ...
        self.exit = QLineEdit(self, placeholderText="Контактная почта для выхода...")

        self.famil = QLineEdit(self, placeholderText="Фамилия")
        self.name = QLineEdit(self, placeholderText="Имя")
        self.otch = QLineEdit(self, placeholderText="Отчество")
        self.date = QLineEdit(self, placeholderText="Дата рождения")
        self.cel = QLineEdit(self, placeholderText="Цель визита")
        self.nomer = QLineEdit(self, placeholderText="Номер телефона")
        self.pochta = QLineEdit(self, placeholderText="Контактная почта")
        ...
        self.setLayout(layout)
        self.setWindowTitle('КПП для гостей')
